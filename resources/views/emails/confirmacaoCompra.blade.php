...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
  ...
  <body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #f8fcfe">
      ...
      <tbody>
        <tr style="vertical-align: top" valign="top">
          <td style="word-break: break-word; vertical-align: top" valign="top">
            <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color:#f8fcfe"><![endif]-->
            ...
            <div style="background-color: #20c56c">
              <div
                class="block-grid"
                style="
                  min-width: 320px;
              ...
              >
                <div style="border-collapse: collapse; display: table; width: 100%; background-color: transparent">
                  <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#20c56c;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:500px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
                        ...
                        >
                          ...
                          >
                            <p style="font-size: 24px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 29px; margin: 0">
                              <span style="font-size: 24px"><strong>Avisaremos quando estiverem a caminho</strong></span>
                            </p>
                          </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
            ...
            <div style="background-color: #f8fcfe">
              ...
              >
                <div style="border-collapse: collapse; display: table; width: 100%; background-color: #ffffff">
                  <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f8fcfe;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:500px"><tr class="layout-full-width" style="background-color:#ffffff"><![endif]-->
                  <!--[if (mso)|(IE)]><td align="center" width="500" style="background-color:#ffffff;width:500px; border-top: 1px solid #B2C9DF55; border-left: 1px solid #B2C9DF55; border-bottom: 1px solid #B2C9DF55; border-right: 1px solid #B2C9DF55;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 25px; padding-left: 25px; padding-top:25px; padding-bottom:25px;"><![endif]-->
                  <div class="col num12" style="min-width: 320px; max-width: 500px; display: table-cell; vertical-align: top; width: 498px">
                    <div class="col_cont" style="width: 100% !important">
                      <!--[if (!mso)&(!IE)]><!-->
                      <div
                        style="
                          border-top: 1px solid #b2c9df55;
                          border-left: 1px solid #b2c9df55;
                          border-bottom: 1px solid #b2c9df55;
                          border-right: 1px solid #b2c9df55;
                          padding-top: 25px;
                          padding-bottom: 25px;
                          padding-right: 25px;
                          padding-left: 25px;
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0">
                              <strong><span style="font-size: 18px">Resumo da compra</span></strong>
                            </p>
                            ...
                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0"> </p>
                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0">
                              Você poderá devolver os produtos até 7 dias após o recebimento
                            </p>
                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0">
                              <a
                        ...
                        >
                          ...
                          <a
                            ...
                            style="
                              ...
                              width: auto;
                              width: auto;
                              border-top: 1px solid #273275;
                              border-right: 1px solid #273275;
                              border-bottom: 1px solid #273275;
                              border-left: 1px solid #273275;
                              padding-top: 5px;
                              padding-bottom: 5px;
                              font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif;
                              text-align: center;
