...
curl -X POST \
    ...
    -d '{"api_token":"b1e04a93c85e3711b2d4972b4d81796c-eccbc87e4b5ce2fe28308fd9f2a7baf3","empresa_id":7,"nome":"et"}'
...
curl -X PUT \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"api_token":"b1e04a93c85e3711b2d4972b4d81796c-eccbc87e4b5ce2fe28308fd9f2a7baf3","empresa_id":12,"nome":"corrupti"}'
...
```bash
curl -X GET \
    -G "https://api.estoqueintegrado.com.br/v1/sizes/7" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```javascript
const url = new URL(
    "https://api.estoqueintegrado.com.br/v1/sizes/7"
);
