...
curl -X POST \
    ...
    -d '{"api_token":"b1e04a93c85e3711b2d4972b4d81796c-eccbc87e4b5ce2fe28308fd9f2a7baf3","empresa_id":7,"user_id":12,"rua":"molestiae","numero":12,"bairro":"adipisci","complemento":"maiores","cidade":"consequatur","uf":"tempore","pais":"nam","cep":"dolor","padrao":"sint","ativo":"ea"}'
...
Cep da rua</p>
<p>
<b><code>padrao</code></b>&nbsp;&nbsp;<small>booelan</small>     <i>optional</i> &nbsp;
<input type="text" name="padrao" data-endpoint="POSTv1-address" data-component="body"  hidden>
<br>
Se o endereço é o padrão</p>
<p>
<b><code>ativo</code></b>&nbsp;&nbsp;<small>booelan</small>     <i>optional</i> &nbsp;
<input type="text" name="ativo" data-endpoint="POSTv1-address" data-component="body"  hidden>
<br>
...
```bash
curl -X PUT \
    "https://api.estoqueintegrado.com.br/v1/address/19" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"api_token":"b1e04a93c85e3711b2d4972b4d81796c-eccbc87e4b5ce2fe28308fd9f2a7baf3","rua":"minus","numero":1,"bairro":"unde","complemento":"officia","cidade":"nihil","uf":"soluta","pais":"autem","cep":"quis","padrao":"fuga","ativo":"eius"}'
...
<p>
<b><code>padrao</code></b>&nbsp;&nbsp;<small>booelan</small>     <i>optional</i> &nbsp;
<input type="text" name="padrao" data-endpoint="PUTv1-address--id-" data-component="body"  hidden>
<br>
Se o endereço é o padrão</p>
<p>
<b><code>ativo</code></b>&nbsp;&nbsp;<small>booelan</small>     <i>optional</i> &nbsp;
<input type="text" name="ativo" data-endpoint="PUTv1-address--id-" data-component="body"  hidden>
<br>
...
```bash
curl -X GET \
    -G "https://api.estoqueintegrado.com.br/v1/address/9" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
...
```javascript
const url = new URL(
    "https://api.estoqueintegrado.com.br/v1/address/9"
);
...
```bash
curl -X DELETE \
    "https://api.estoqueintegrado.com.br/v1/address/11" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"api_token":"b1e04a93c85e3711b2d4972b4d81796c-eccbc87e4b5ce2fe28308fd9f2a7baf3"}'
